...
<section class="w3-padding">
   ...
   <form method="post" action="/console/products/edit/<?= $product->id ?>" novalidate class="w3-margin-bottom">
      ...
      <div class="w3-margin-bottom">
         ...
         <input type="text" name="model" id="model" value="<?= old('model'),$product->model ?>" required>
      ...
      <div class="w3-margin-bottom">
         ...
         <textarea name="description" id="description" required> <?= old('description'), $product->description ?>
         </textarea>
      ...
      <button type="submit" class="w3-button w3-green">Edit Products</button>
